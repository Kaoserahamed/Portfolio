              ...
              <div className="p-8">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                  ...
                  <div className="md:text-right">
                    <span className="inline-block bg-slate-100 px-4 py-2 rounded-full text-sm font-medium text-slate-700 mb-2">
                      {edu.period}
                    </span>
        ...
        <div className="max-w-4xl mx-auto mt-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={index}
                className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-4 text-center hover:shadow-lg transition-shadow"
              >
                <div className="text-3xl mb-2">{interest.icon}</div>
                <div className="font-semibold text-slate-900">{interest.name}</div>
              </div>
            ))}
          </div>
        </div>
