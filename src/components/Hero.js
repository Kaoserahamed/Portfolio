      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
            Computer Science student specializing in building scalable web applications
            with React, Node.js, and MongoDB. Passionate about Machine Learning and solving
            complex problems.
          </p>
