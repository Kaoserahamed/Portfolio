...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-12 md:py-24 bg-slate-50">
              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, skillIndex) => (
                    <span
                      key={skillIndex}
                      className="bg-slate-50 text-slate-700 px-3 py-1 rounded-full text-sm font-medium hover:bg-slate-100 transition-colors"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <span className="text-lg font-bold text-slate-900">Codeforces</span>
              <span className="text-sm text-slate-600 mt-1">Problem Solving</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-lg font-bold text-slate-900">LeetCode</span>
              <span className="text-sm text-slate-600 mt-1">Algorithms & DS</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-lg font-bold text-slate-900">GeeksforGeeks</span>
              <span className="text-sm text-slate-600 mt-1">Practice & Learn</span>
            </a>
          </div>
        </div>
      </div>
