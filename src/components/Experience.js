const Experience = () => {
  return (
    <section id="experience" className="py-8 px-6 bg-dark">
      <div className="container mx-auto max-w-7xl">
        <h2 className="text-3xl font-heading font-bold text-white mb-4">Experience</h2>
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-slate-300">
              <li className="flex items-start">
                ...
                <span>Evaluated and ranked LLM-generated responses across coding, logical reasoning, and mathematics tasks</span>
              </li>
              <li className="flex items-start">
                <span className="text-accent mr-2">▹</span>
                <span>Identified recurring model failure patterns, edge cases, and reasoning issues to improve response quality</span>
              </li>
              <li className="flex items-start">
                <span className="text-accent mr-2">▹</span>
                <span>Created and reviewed structured training examples using prompt engineering and response evaluation</span>
              </li>
            </ul>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <span className="px-3 py-1 bg-primary/20 text-primary text-sm rounded-lg border border-primary/30">Model Training</span>
            </div>
          </div>
        </div>
      </div>
